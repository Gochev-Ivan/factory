...
def control(agv_coord, agv_velocities, pathfinder_coord):
    ...
    v_left_motor = initial_motor_speed + Kp * np.arctan2(pathfinder_coord[1], pathfinder_coord[0])
    v_right_motor = initial_motor_speed - Kp * np.arctan2(pathfinder_coord[1], pathfinder_coord[0])
